...
export async function cleanupOrphanedTempFiles() {
  ...
  const videoPath = `Download/${localStorage.getItem("mori_download_path") || "Moonlight"}`;
  const musicPath = `Download/${localStorage.getItem("mori_music_path") || "Moonlight/Music"}`;
  const platforms = [
    "",
    "/TikTok",
    "/Douyin",
